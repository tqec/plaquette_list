...
\usepackage[export]{adjustbox} % Max width in include graphics
% \newcommand{\insertPlaquette}[1]{%
% \begin{figure}
%     \centering
%     \begin{subfigure}[b]{.3\textwidth}
%         \centering
%         \includegraphics[width=\textwidth, max height=\textwidth]{plaquettes/pdf/#1.pdf}
%         \caption{\texttt{#1} plaquette}
%         \label{fig:#1-plaquette}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{.65\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{circuits/pdf/#1.pdf}
%         \caption{\texttt{#1} circuit}
%         \label{fig:#1-circuit}
%     \end{subfigure}
%     \caption{\texttt{#1} plaquette and circuit}
%     \label{fig:#1-combined}
% \end{figure}
% }
\newcommand{\insertPlaquette}[1]{%
    \label{tabrow:#1} &%
...
% \newcommand{\internalTableLine}[3]{\texttt{#1} & \texttt{#2} & #3 & }
...
\begin{longtable}{ |l|l|l|l| } 
    ...
    \hline
    % \texttt{thXXXX} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thXX_UP} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thXX_DOWN} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thXX_RIGHT} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thXX_LEFT} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thZZZZ} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thZZ_UP} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thZZ_DOWN} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thZZ_RIGHT} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \texttt{thZZ_LEFT} & \texttt{Memory \& Transversal $H$} & Temporal transversal $H$ & Figure \ref{fig:XXXX-combined} \\
    % \hline
\end{longtable}
